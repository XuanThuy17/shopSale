...
const BuyModal = (props) => {
  ...
  const [currentColor, setColor] = useState(
    listColor.length > 0 ? listColor[0].color : ""
  );
  const [currentSize, setSize] = useState(
    listSize.length > 0 ? listSize[0].size : ""
  );
  ...
  return (
    <Modal
      ...
      contentClassName="buy-modal-content"
      centered>
              ...
              <div className="col-12 col-sm-6">
                <div className="info-product">
                  <div className="title-product">
                    <h1><Link to="">Michigan State Football Skeleton - Unisex t-shirt</Link></h1>
                        ...
                        listColor.map((item, index) => {
                          return (
                            ...
                            >
                              <button
                                className={
                                  currentColor === item.color ? "active" : ""
                                }
                              >
                                {item.color}
                              </button>
